...
const BulkEdit = () => {
    ...
    return (
        <div>
                                ...
                                <Form.Check
                                    ...
                                    onChange={(event) => {
                                        ...
                                        if (!event.target.checked) {
                                            setSelectedInvoices(
                                                selectedInvoices.filter(inv => { return inv !== invoice.invoiceNumber }
                                                )
                                            )
                                        }
                                        else {
                                            setSelectedInvoices(
                                                [...selectedInvoices, invoice.invoiceNumber]
                                            )
                                        }
            ...
            {(selectedInvoices.length!==0) && (<Button variant="primary" onClick={handleContinue}>
                Continue
            </Button>)}
        </div>
    );
